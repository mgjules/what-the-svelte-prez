...
Who are we? <!-- .element: class="fragment" data-fragment-index="0" -->

Probably the hot.. <!-- .element: class="fragment" data-fragment-index="1" --> 
...
<img src="/img/me.png" width="300px"/> <!-- .element: class="fragment" data-fragment-index="0" -->

I engineer software @  <!-- .element: class="fragment" data-fragment-index="1" --> <span style="color: #4285F4" class="fragment" data-fragment-index="1">LSL Digital</span>

Specialize in Back-End technologies <!-- .element: class="fragment" data-fragment-index="2" -->

Work primarily in  <!-- .element: class="fragment" data-fragment-index="3" --> <span style="color: #4285F4" class="fragment" data-fragment-index="3">Go</span>
...
- You don't have to act on anything being shown in that presentation. <!-- .element: class="fragment" data-fragment-index="0" -->
- Don't sue me if you hate whatever technology you are using right now because can't ditch it because of work (maybe: NSFW). <!-- .element: class="fragment" data-fragment-index="1" -->
- I am no JS God. Very newbish infact! <!-- .element: class="fragment" data-fragment-index="2" -->



# Svelte 

Another JS framework!!! <!-- .element: class="fragment" data-fragment-index="0" -->

<img src="/img/annoyed.gif" /> <!-- .element: class="fragment" data-fragment-index="1" -->
...
This is not a competition <!-- .element: class="fragment" data-fragment-index="0" -->

So relax and get your kitty's claws back inside <!-- .element: class="fragment" data-fragment-index="1" -->

<img src="/img/kittyclaws.gif"> <!-- .element: class="fragment" data-fragment-index="1" -->



## But wait!! 

Something is different this time! <!-- .element: class="fragment" data-fragment-index="0" -->
...
<!-- .slide: data-background-iframe="https://svelte.dev" data-preload> -->
...
<!-- .slide: data-background-iframe="https://svelte.dev/examples" data-background-interactive data-preload> -->



## Enough fooling around

Let's build something! <!-- .element: class="fragment" data-fragment-index="0" -->
...
Je s'appelle Groot! <!-- .element: class="fragment" data-fragment-index="0" -->
...
<!-- .slide: data-background-color="#FFFFFF" data-background-iframe="https://lexpress.mu/jioi" data-background-interactive data-preload> -->



## Perfs ?

<img src="/img/metrics.jpg" width="600px"/> <!-- .element: class="fragment" data-fragment-index="0" -->
...
<img src="/img/thatsall.gif" /> <!-- .element: class="fragment" data-fragment-index="0" -->
